...
export default class SegmentRemoveCustomersModal extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
    ...
    handleRemoveClick = (groupId, id) => {
        console.warn(groupId, id)
        SegmentService
            .destroyCustomer({data: {group_id: groupId}, id})
    ...
    render() {
        const { modalRemoveOpen, groupId, id } = this.state;
                ...
                <Form>
                    <Form.Group className="d-flex justify-content-between">
                        <Form.Field
                            control={Button}
                            content='Yes'
                            onClick={() => this.handleRemoveClick(groupId, id)}
                            style={{marginTop: 20}}
                        />
                        <Form.Field
                            control={Button}
